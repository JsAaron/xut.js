...
* v856  2016.19.26 解决同一个页面零件，重复多次加载的问题。js与css 。历史问题第一次解决
* v855  2016.19.26 初始化层级修正
* v854  2016.19.26 文本卷滚修正
* v853  2016.19.25 修正横路切换应用，默认浏览器上支持横竖切换
* v852  2016.19.25 修正swipe、flow在手机端页面上下默认滑动的问题
* v851  2016.19.25 插件支持 Xut.plat.hasPlugin
* v850  2016.19.25 整理文件结构
* v849  2016.19.24 合并零件文本框到xxtppt.js
