 ...
 */
export function Recorder(config) {
  ...
  function successCB(stream) { //成功回调
    ...
    var realTimeWorker = new Worker('./src/core/expand/recorder/worker.js'); //开启后台线程
