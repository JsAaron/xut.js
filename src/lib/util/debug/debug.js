...
(function (WIN, DOC) {
  ...
  Debug = (function () {
    ...
    childCss = ["margin-top:-1px", "padding:1px", "border-top:1px solid rgba(255,255,255,.1)", "margin:0", "max-width:" + (WIN.outerWidth - 20) + "px"].concat(publicCss);

    parentCss = ["-webkit-overflow-scrolling:touch", "overflow:scroll", "line-height:1.2", "z-index:5000", "position:fixed", "left:0", "top:0", "font-size:11px", "background:rgba(0,0,0,.8)", "color:#fff", "width:100%", "padding-bottom:" + parentBottom + "px", "max-height:50%"].concat(publicCss);
