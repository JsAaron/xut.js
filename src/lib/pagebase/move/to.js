 ...
 * 移动视觉差对象
 */
const _translate = function(rootNode, scope, direction, action, speed, nodes, distance) {
            ...
            _.each(baseContents, function(content) {
                content.eachAssistContents(function(scope) {
                    ...
                    if (scope.parallax) {
                        ...
                        //移动视觉差对象
                        _translate(rootNode, scope.parallax, direction, action, speed, nodes, distance);
                    }
                })
            })
        }
