	...
	var sysBar = function (_Bar) {
	    ...
	    _createClass(sysBar, [{
	        ...
	        value: function createDirIcon(bar) {
	            var str = '<div id="xut-nav-backdir" class="xut-controlBar-backDir" style="float:left;margin-left:4px;width:{0}px;height:{1}px;background-size:cover"></div>',
	                height = this.iconHeight,
	                html = $(String.format(str, height, height));
	            bar.append(html);
	        }
	        ...
	        value: function createHideToolbar(bar) {
	            ...
	            html = '<div id="xut-nav-hidetoolbar" class="xut-controlBar-hide" style="' + style + '"></div>';
	            bar.append(html);
	        }
...
//# sourceMappingURL=0.bd656621be905d7134e9.hot-update.js.map