	...
	var Section = function () {
	    ...
	    _createClass(Section, [{
	        ...
	        value: function createThumb() {
	            ...
	            createNew = [],
	                //新建的页码索引
	            _pageArray = this._pageArray,
	                list = this.list,
	                maxLen = _pageArray.length,
	        ...
	        value: function getViewLen() {
	            var hBox = this.hBox,
	                ...
	                //单个li的高度,
	            count = 1,
	                len = this._pageArray.length; //li的总数
...
//# sourceMappingURL=0.921bd50f086795e899ca.hot-update.js.map