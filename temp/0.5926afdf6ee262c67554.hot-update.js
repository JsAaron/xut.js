...
/***/ function(module, exports, __webpack_require__) {
	...
	function home() {
	    ...
	    //主体
	    var homeHTML = '<div id="sceneHome" class="xut-chapter" style="' + 'width:{{width}}px;' + 'height:{{height}}px;' + 'top:{{top}}px;' + 'left:{{left}}px;' + 'overflow:hidden;' + 'z-index:{{index}};' + 'overflow:{{overflow}};" >' + ' <div id="controlBar" class="xut-controlBar hide"></div>' +
	    //页面节点
...
//# sourceMappingURL=0.5926afdf6ee262c67554.hot-update.js.map