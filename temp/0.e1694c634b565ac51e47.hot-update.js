	...
	var fnBar = function (_Bar) {
	    ...
	    _createClass(fnBar, [{
	        ...
	        value: function createSystemBar() {
	            ...
	            html = '<div id="controlBar' + id + '" class="xut-control-bar" style="' + style + '"></div>';
	            html = $(html);
	            this.top = TOP;
	            this.showSystemBar();
	        ...
	        value: function createPageNum(container) {
	            ...
	            html = '<div class="xut-nav-page" style="' + style + '">';
	        ...
	        value: function createHideToolbar(container) {
	            ...
	            html = '<div class="xut-nav-hide" style="' + style + '"></div>';
	            container.append(html);
	        }
...
//# sourceMappingURL=0.e1694c634b565ac51e47.hot-update.js.map