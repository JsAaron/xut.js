...
/***/ function(module, exports, __webpack_require__) {
	...
	function home() {
	    ...
	    var navBarTop = isHorizontal ? 0 : iconHeight + TOP + 2 + 'px';
	    var navBarLeft = isHorizontal ? 0 : iconHeight + 'px';
	    var navBarBottom = isHorizontal ? '4px' : 0;
	...
	function navMenu(results) {
	    ...
	    //导航
	    var navHTML = '<div id="SectionWrapper" style="' + options.containerstyle + '">\n          <div id="Sectionscroller" style="width:' + options.overwidth + 'px;\n                                           height:' + options.overHeigth + 'px;\n                                           ' + options.scroller + '">\n            <ul id="SectionThelist">\n               {{list}}\n            </ul>\n          </div>\n        </div>';
...
//# sourceMappingURL=0.08d3b2e251cc13b44c56.hot-update.js.map